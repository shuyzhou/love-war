(function () {
	...
	configMenu.addEventListener('click',function(e){
		...
		if(target.nodeName.toLowerCase() === 'input'){
			...
			switch (value) {
				case 'on' : audio.play();break;
				case 'off' : audio.pause();break;
				case 'normal' : multiple = 1;break;
				case 'faster' : multiple = 2;break;
			}
		}
	...
	var main = function () {
		...
		if(mode === 'normal'){
			tick2 = setInterval(function(){time--;},1000);
		}
		run();
	};
